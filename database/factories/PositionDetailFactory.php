...
/**
 * @extends Factory<PositionDetail>
 */
class PositionDetailFactory extends Factory
{
    protected $model = PositionDetail::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'vacation_policy_id' => VacationPolicy::query()->inRandomOrder()->value('id'),
