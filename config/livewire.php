...
return [
    ...
    */
    ...
    |
    | If Filament/Livewire shows a generic "upload failed" / validation.uploaded
    | message, PHP never accepted the multipart upload: raise upload_max_filesize
    | and post_max_size in php.ini (post_max_size must be >= the file size), and
    | for nginx raise client_max_body_size. Behind a reverse proxy, configure
    | TrustProxies and a correct APP_URL so signed /livewire/upload-file URLs work.
    |
    */
