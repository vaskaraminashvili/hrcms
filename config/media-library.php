...
return [
    ...
    /*
     * Allowed MIME types for media collections that use the shared registration helper.
     * Used by Filament Spatie uploads (see ConstrainedSpatieMediaLibraryFileUpload).
     */
    'allowed_mime_types' => [
        'application/pdf',
        'image/jpeg',
